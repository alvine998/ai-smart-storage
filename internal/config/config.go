...
func Load() Config {
	return Config{
		...
		JWTTTLHours:           integer("JWT_TTL_HOURS", 24),
		...
		SignupURL:             value("SIGNUP_URL", value("APP_URL", "http://localhost:8080")+"/signup"),
		AppURL:                value("APP_URL", value("SIGNUP_URL", "http://localhost:8080")),
